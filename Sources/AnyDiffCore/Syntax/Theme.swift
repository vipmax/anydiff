...
public struct Theme: Identifiable, Sendable {
    ...
    public static let zedGray = Theme(
        ...
        name: "Zed Slate Gray",
        isDark: true,
        background: NSColor(red: 0.20, green: 0.21, blue: 0.24, alpha: 1.0),
        gutterBackground: NSColor(red: 0.17, green: 0.18, blue: 0.20, alpha: 1.0),
        currentLineBackground: NSColor(red: 0.24, green: 0.26, blue: 0.30, alpha: 1.0),
        selectionBackground: NSColor(red: 0.32, green: 0.40, blue: 0.55, alpha: 0.65),
        excerptHeaderBackground: NSColor(red: 0.26, green: 0.28, blue: 0.32, alpha: 1.0),
        excerptHeaderBorder: NSColor(red: 0.35, green: 0.38, blue: 0.44, alpha: 1.0),
        foreground: NSColor(red: 0.92, green: 0.94, blue: 0.96, alpha: 1.0),
        gutterForeground: NSColor(red: 0.50, green: 0.54, blue: 0.60, alpha: 1.0),
        gutterActiveForeground: NSColor(red: 0.90, green: 0.92, blue: 0.98, alpha: 1.0),
        foldPlaceholderForeground: NSColor(red: 0.58, green: 0.63, blue: 0.70, alpha: 1.0),
