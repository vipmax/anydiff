...
public struct Theme: Identifiable, Sendable {
    ...
    public static let zedGray = Theme(
        ...
        name: "Zed Slate Gray",
        isDark: true,
        background: NSColor(red: 0.115, green: 0.120, blue: 0.135, alpha: 1.0),
        gutterBackground: NSColor(red: 0.095, green: 0.100, blue: 0.115, alpha: 1.0),
        currentLineBackground: NSColor(red: 0.160, green: 0.170, blue: 0.190, alpha: 1.0),
        selectionBackground: NSColor(red: 0.240, green: 0.320, blue: 0.460, alpha: 0.65),
        excerptHeaderBackground: NSColor(red: 0.155, green: 0.165, blue: 0.185, alpha: 1.0),
        excerptHeaderBorder: NSColor(red: 0.220, green: 0.235, blue: 0.260, alpha: 1.0),
        foreground: NSColor(red: 0.90, green: 0.92, blue: 0.95, alpha: 1.0),
        gutterForeground: NSColor(red: 0.45, green: 0.48, blue: 0.55, alpha: 1.0),
        gutterActiveForeground: NSColor(red: 0.90, green: 0.92, blue: 0.98, alpha: 1.0),
        foldPlaceholderForeground: NSColor(red: 0.52, green: 0.56, blue: 0.64, alpha: 1.0),
