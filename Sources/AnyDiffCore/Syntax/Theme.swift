...
public struct Theme: Identifiable, Sendable {
    ...
    public static let zedGray = Theme(
        ...
        name: "Zed Slate Gray",
        isDark: true,
        background: NSColor(red: 0.16, green: 0.17, blue: 0.19, alpha: 1.0),
        gutterBackground: NSColor(red: 0.13, green: 0.14, blue: 0.16, alpha: 1.0),
        currentLineBackground: NSColor(red: 0.20, green: 0.22, blue: 0.25, alpha: 1.0),
        selectionBackground: NSColor(red: 0.28, green: 0.36, blue: 0.50, alpha: 0.65),
        excerptHeaderBackground: NSColor(red: 0.19, green: 0.20, blue: 0.23, alpha: 1.0),
        excerptHeaderBorder: NSColor(red: 0.26, green: 0.28, blue: 0.32, alpha: 1.0),
        foreground: NSColor(red: 0.88, green: 0.90, blue: 0.93, alpha: 1.0),
        gutterForeground: NSColor(red: 0.48, green: 0.52, blue: 0.58, alpha: 1.0),
        gutterActiveForeground: NSColor(red: 0.88, green: 0.90, blue: 0.95, alpha: 1.0),
        ...
        comment: NSColor(red: 0.50, green: 0.55, blue: 0.62, alpha: 1.0),
        property: NSColor(red: 0.72, green: 0.82, blue: 0.95, alpha: 1.0),
        operator: NSColor(red: 0.52, green: 0.75, blue: 0.88, alpha: 1.0),
        punctuation: NSColor(red: 0.68, green: 0.72, blue: 0.80, alpha: 1.0),
