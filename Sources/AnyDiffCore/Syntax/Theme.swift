...
public struct Theme: Identifiable, Sendable {
    ...
    public static let zedGray = Theme(
        ...
        name: "Zed Slate Gray",
        isDark: true,
        background: NSColor(red: 0.22, green: 0.225, blue: 0.240, alpha: 1.0),
        gutterBackground: NSColor(red: 0.19, green: 0.195, blue: 0.210, alpha: 1.0),
        currentLineBackground: NSColor(red: 0.25, green: 0.26, blue: 0.280, alpha: 1.0),
        selectionBackground: NSColor(red: 0.34, green: 0.42, blue: 0.580, alpha: 0.65),
        excerptHeaderBackground: NSColor(red: 0.265, green: 0.275, blue: 0.295, alpha: 1.0),
        excerptHeaderBorder: NSColor(red: 0.35, green: 0.36, blue: 0.390, alpha: 1.0),
        foreground: NSColor(red: 0.92, green: 0.94, blue: 0.96, alpha: 1.0),
        gutterForeground: NSColor(red: 0.52, green: 0.56, blue: 0.62, alpha: 1.0),
        gutterActiveForeground: NSColor(red: 0.92, green: 0.94, blue: 0.98, alpha: 1.0),
        foldPlaceholderForeground: NSColor(red: 0.58, green: 0.62, blue: 0.70, alpha: 1.0),
        keyword: NSColor(red: 0.94, green: 0.50, blue: 0.58, alpha: 1.0),
        type: NSColor(red: 0.92, green: 0.78, blue: 0.50, alpha: 1.0),
        function: NSColor(red: 0.44, green: 0.72, blue: 0.98, alpha: 1.0),
        string: NSColor(red: 0.62, green: 0.85, blue: 0.54, alpha: 1.0),
        number: NSColor(red: 0.90, green: 0.65, blue: 0.42, alpha: 1.0),
        comment: NSColor(red: 0.55, green: 0.60, blue: 0.68, alpha: 1.0),
        property: NSColor(red: 0.74, green: 0.84, blue: 0.98, alpha: 1.0),
        operator: NSColor(red: 0.54, green: 0.78, blue: 0.90, alpha: 1.0),
        ...
        diffAddedBackground: NSColor(red: 0.20, green: 0.45, blue: 0.25, alpha: 0.32),
        diffAddedWordHighlight: NSColor(red: 0.25, green: 0.65, blue: 0.35, alpha: 0.52),
        diffDeletedGutter: NSColor(red: 0.92, green: 0.32, blue: 0.38, alpha: 1.0),
        diffDeletedBackground: NSColor(red: 0.48, green: 0.18, blue: 0.22, alpha: 0.32),
        diffDeletedWordHighlight: NSColor(red: 0.78, green: 0.20, blue: 0.26, alpha: 0.52),
